import { ComponentFactoryResolver, ComponentRef, Directive, ElementRef, EventEmitter, HostListener, Injector, Input, Output, ViewContainerRef } from '@angular/core';
...
@Directive({
  selector: 'textarea[textAutocomplete]'
})
export class AutocompleteDirective {
  ...
  //  @Input() keyboardShortcut: (event: KeyboardEvent) => boolean;
    ...
    */
   @Input() menuComponent = AutocompleteComponent;
   ...
   private menu:
     | {
         component: ComponentRef<AutocompleteComponent>;
